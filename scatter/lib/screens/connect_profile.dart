...
class ConnectSocialProfileScreen extends StatefulWidget {
  const ConnectSocialProfileScreen({super.key});

  @override
  State<ConnectSocialProfileScreen> createState() => _ConnectSocialProfileScreenState();
}

class _ConnectSocialProfileScreenState extends State<ConnectSocialProfileScreen> {
  @override
                  ...
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: Color(0xFFDCDCDC), width: 2.5)),
